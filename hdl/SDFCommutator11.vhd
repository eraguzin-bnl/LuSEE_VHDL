-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/SDFCommutator11.vhd
...
-- Source Path: sfft_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_11/SDFCommutator11
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator11 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL xf_im_signed                     : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL dinXTwdlf_re_signed              : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL dinXTwdlf_im_signed              : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL btf1_re_signed                   : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL btf1_im_signed                   : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL btf2_re_signed                   : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL btf2_im_signed                   : signed(42 DOWNTO 0);  -- sfix43_En18
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFCummutator_out_im_next        : signed(42 DOWNTO 0);  -- sfix43_En18
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En18
  ...
  SIGNAL wrData_re_tmp                    : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL wrData_im_tmp                    : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL xData_re                         : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL xData_im                         : signed(42 DOWNTO 0);  -- sfix43_En18
  ...
  SIGNAL dout0_re                         : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL dout0_im                         : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL xX_re_signed                     : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL xX_im                            : std_logic_vector(42 DOWNTO 0);  -- ufix43
  SIGNAL xX_im_signed                     : signed(42 DOWNTO 0);  -- sfix43_En18
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_11_1_re_tmp                 : signed(42 DOWNTO 0);  -- sfix43_En18
  SIGNAL dout_11_1_im_tmp                 : signed(42 DOWNTO 0);  -- sfix43_En18
