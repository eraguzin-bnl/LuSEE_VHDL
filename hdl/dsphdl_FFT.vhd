-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/dsphdl_FFT.vhd
-- Created: 2023-01-17 10:39:48
-- 
...
-- 
-- Module: dsphdl_FFT
-- Source Path: sfft_fixpt/dsphdl.FFT
-- Hierarchy Level: 1
-- 
-- FFT
-- 
...
ARCHITECTURE rtl OF dsphdl_FFT IS
  ...
  COMPONENT RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_1_1_re_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En18
          din_1_1_im_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En18
          din_1_vld_dly                   :   IN    std_logic;
          rd_1_Addr                       :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
          rd_1_Enb                        :   IN    std_logic;
          twdl_1_1_re                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_1_1_im                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_1_1_vld                    :   IN    std_logic;
          proc_1_enb                      :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_1_1_re                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33_En18
          dout_1_1_im                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33_En18
  ...
  COMPONENT RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_1_1_re                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33_En18
          dout_1_1_im                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33_En18
          dout_1_1_vld                    :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_2_1_re                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En18
          dout_2_1_im                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En18
  ...
  COMPONENT RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En18
          din_5_1_im_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36_En18
          ...
          softReset                       :   IN    std_logic;
          dout_5_1_re                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En18
          dout_5_1_im                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En18
  ...
  COMPONENT RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_5_1_re                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En18
          dout_5_1_im                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En18
          dout_5_1_vld                    :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_6_1_re                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38_En18
          dout_6_1_im                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38_En18
  ...
  COMPONENT RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_7_1_re_dly                  :   IN    std_logic_vector(37 DOWNTO 0);  -- sfix38_En18
          din_7_1_im_dly                  :   IN    std_logic_vector(37 DOWNTO 0);  -- sfix38_En18
          ...
          softReset                       :   IN    std_logic;
          dout_7_1_re                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dout_7_1_im                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
  ...
  COMPONENT RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_7_1_re                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dout_7_1_im                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dout_7_1_vld                    :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_8_1_re                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40_En18
          dout_8_1_im                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40_En18
  ...
  COMPONENT RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_9_1_re_dly                  :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En18
          din_9_1_im_dly                  :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En18
          ...
          softReset                       :   IN    std_logic;
          dout_9_1_re                     :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En18
          dout_9_1_im                     :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En18
  ...
  COMPONENT RADIX22FFT_SDF2_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_9_1_re                     :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En18
          dout_9_1_im                     :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En18
          dout_9_1_vld                    :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_10_1_re                    :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En18
          dout_10_1_im                    :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En18
  ...
  COMPONENT RADIX22FFT_SDF2_12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_11_1_re                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En18
          dout_11_1_im                    :   IN    std_logic_vector(42 DOWNTO 0);  -- sfix43_En18
          dout_11_1_vld                   :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_12_1_re                    :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
          dout_12_1_im                    :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
  ...
  COMPONENT RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_12_1_re                    :   IN    std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
          dout_12_1_im                    :   IN    std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
          dout_12_1_vld                   :   IN    std_logic;
          softReset                       :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
          dout_im1                        :   OUT   std_logic_vector(43 DOWNTO 0);  -- sfix44_En18
  ...
  SIGNAL dataIn_re_signed                 : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL dataIn_im_signed                 : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL dataIn_1_cast_re                 : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL dataIn_1_cast_im                 : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL intdelay_reg                     : vector_of_signed32(0 TO 2);  -- sfix32 [3]
  SIGNAL din_1_1_re_dly                   : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL intdelay_reg_1                   : vector_of_signed32(0 TO 2);  -- sfix32 [3]
  SIGNAL din_1_1_im_dly                   : signed(31 DOWNTO 0);  -- sfix32_En18
  SIGNAL intdelay_reg_2                   : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL din_1_vld_dly                    : std_logic;
  SIGNAL twdl_1_1_re                      : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL twdl_1_1_im                      : signed(31 DOWNTO 0);  -- sfix32_En30
  ...
  SIGNAL dout_2_1_re_signed               : signed(33 DOWNTO 0);  -- sfix34_En18
  SIGNAL dout_2_1_im_signed               : signed(33 DOWNTO 0);  -- sfix34_En18
  SIGNAL intdelay_reg_4                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_re_dly                   : signed(33 DOWNTO 0);  -- sfix34_En18
  SIGNAL intdelay_reg_5                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_im_dly                   : signed(33 DOWNTO 0);  -- sfix34_En18
  ...
  SIGNAL dout_4_1_re_signed               : signed(35 DOWNTO 0);  -- sfix36_En18
  SIGNAL dout_4_1_im_signed               : signed(35 DOWNTO 0);  -- sfix36_En18
  SIGNAL intdelay_reg_7                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_re_dly                   : signed(35 DOWNTO 0);  -- sfix36_En18
  SIGNAL intdelay_reg_8                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_im_dly                   : signed(35 DOWNTO 0);  -- sfix36_En18
  ...
  SIGNAL dout_6_1_re_signed               : signed(37 DOWNTO 0);  -- sfix38_En18
  SIGNAL dout_6_1_im_signed               : signed(37 DOWNTO 0);  -- sfix38_En18
  SIGNAL intdelay_reg_10                  : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_re_dly                   : signed(37 DOWNTO 0);  -- sfix38_En18
  SIGNAL intdelay_reg_11                  : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_im_dly                   : signed(37 DOWNTO 0);  -- sfix38_En18
  ...
  SIGNAL dout_8_1_re_signed               : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL dout_8_1_im_signed               : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL intdelay_reg_13                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_1_re_dly                   : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL intdelay_reg_14                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_1_im_dly                   : signed(39 DOWNTO 0);  -- sfix40_En18
  ...
  SIGNAL dout_10_1_re_signed              : signed(41 DOWNTO 0);  -- sfix42_En18
  SIGNAL dout_10_1_im_signed              : signed(41 DOWNTO 0);  -- sfix42_En18
  SIGNAL intdelay_reg_16                  : vector_of_signed42(0 TO 2);  -- sfix42 [3]
  SIGNAL din_11_1_re_dly                  : signed(41 DOWNTO 0);  -- sfix42_En18
  SIGNAL intdelay_reg_17                  : vector_of_signed42(0 TO 2);  -- sfix42 [3]
  SIGNAL din_11_1_im_dly                  : signed(41 DOWNTO 0);  -- sfix42_En18
  ...
  SIGNAL twdl_11_1_vld                    : std_logic;
...
BEGIN
  ...
  u_SDF1_1_1 : RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_1_1_re_dly => std_logic_vector(din_1_1_re_dly),  -- sfix32_En18
              din_1_1_im_dly => std_logic_vector(din_1_1_im_dly),  -- sfix32_En18
              din_1_vld_dly => din_1_vld_dly,
              rd_1_Addr => rd_1_Addr,  -- ufix11
              rd_1_Enb => rd_1_Enb,
              twdl_1_1_re => std_logic_vector(twdl_1_1_re),  -- sfix32_En30
              twdl_1_1_im => std_logic_vector(twdl_1_1_im),  -- sfix32_En30
              twdl_1_1_vld => twdl_1_1_vld,
              proc_1_enb => proc_1_enb,
              softReset => softReset,
              dout_1_1_re => dout_1_1_re,  -- sfix33_En18
              dout_1_1_im => dout_1_1_im,  -- sfix33_En18
  ...
  u_SDF2_2_1 : RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              ...
              multiply_2_J => multiply_2_J,
              softReset => softReset,
              dout_2_1_re => dout_2_1_re,  -- sfix34_En18
              dout_2_1_im => dout_2_1_im,  -- sfix34_En18
  ...
  u_SDF1_3_1 : RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_1_re_dly => std_logic_vector(din_3_1_re_dly),  -- sfix34_En18
              din_3_1_im_dly => std_logic_vector(din_3_1_im_dly),  -- sfix34_En18
              ...
              proc_3_enb => proc_3_enb,
              softReset => softReset,
              dout_3_1_re => dout_3_1_re,  -- sfix35_En18
              dout_3_1_im => dout_3_1_im,  -- sfix35_En18
  ...
  u_SDF2_4_1 : RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              ...
              multiply_4_J => multiply_4_J,
              softReset => softReset,
              dout_4_1_re => dout_4_1_re,  -- sfix36_En18
              dout_4_1_im => dout_4_1_im,  -- sfix36_En18
  ...
  u_SDF1_5_1 : RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_5_1_re_dly => std_logic_vector(din_5_1_re_dly),  -- sfix36_En18
              din_5_1_im_dly => std_logic_vector(din_5_1_im_dly),  -- sfix36_En18
              ...
              proc_5_enb => proc_5_enb,
              softReset => softReset,
              dout_5_1_re => dout_5_1_re,  -- sfix37_En18
              dout_5_1_im => dout_5_1_im,  -- sfix37_En18
  ...
  u_SDF2_6_1 : RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              ...
              multiply_6_J => multiply_6_J,
              softReset => softReset,
              dout_6_1_re => dout_6_1_re,  -- sfix38_En18
              dout_6_1_im => dout_6_1_im,  -- sfix38_En18
  ...
  u_SDF1_7_1 : RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_1_re_dly => std_logic_vector(din_7_1_re_dly),  -- sfix38_En18
              din_7_1_im_dly => std_logic_vector(din_7_1_im_dly),  -- sfix38_En18
              ...
              proc_7_enb => proc_7_enb,
              softReset => softReset,
              dout_7_1_re => dout_7_1_re,  -- sfix39_En18
              dout_7_1_im => dout_7_1_im,  -- sfix39_En18
  ...
  u_SDF2_8_1 : RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              ...
              multiply_8_J => multiply_8_J,
              softReset => softReset,
              dout_8_1_re => dout_8_1_re,  -- sfix40_En18
              dout_8_1_im => dout_8_1_im,  -- sfix40_En18
  ...
  u_SDF1_9_1 : RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_9_1_re_dly => std_logic_vector(din_9_1_re_dly),  -- sfix40_En18
              din_9_1_im_dly => std_logic_vector(din_9_1_im_dly),  -- sfix40_En18
              ...
              proc_9_enb => proc_9_enb,
              softReset => softReset,
              dout_9_1_re => dout_9_1_re,  -- sfix41_En18
              dout_9_1_im => dout_9_1_im,  -- sfix41_En18
  ...
  u_SDF2_10_1 : RADIX22FFT_SDF2_10
    PORT MAP( clk => clk,
              ...
              multiply_10_J => multiply_10_J,
              softReset => softReset,
              dout_10_1_re => dout_10_1_re,  -- sfix42_En18
              dout_10_1_im => dout_10_1_im,  -- sfix42_En18
  ...
  --u_twdlROM_11_1 : TWDLROM_11_1
    --PORT MAP( clk => clk,
              ...
              --twdl_11_1_vld => twdl_11_1_vld
              --);

              --
--u_twdlROM_11_2 : TWDLROM_11_1_array
    --PORT MAP( clk => clk,
              --reset => reset,
              --enb => enb,
              --dout_10_1_vld => dout_10_1_vld,
              --softReset => softReset,
              --twdl_11_1_re => open,  -- sfix32_En30
              --twdl_11_1_im => open,  -- sfix32_En30
              --twdl_11_1_vld => open
              --);
         -- 
...
u_twdlROM_11_2 : TWDLROM_11_1_array
  ...
  u_SDF1_11_1 : RADIX22FFT_SDF1_11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_11_1_re_dly => std_logic_vector(din_11_1_re_dly),  -- sfix42_En18
              din_11_1_im_dly => std_logic_vector(din_11_1_im_dly),  -- sfix42_En18
              ...
              proc_11_enb => proc_11_enb,
              softReset => softReset,
              dout_11_1_re => dout_11_1_re,  -- sfix43_En18
              dout_11_1_im => dout_11_1_im,  -- sfix43_En18
  ...
  u_SDF2_12_1 : RADIX22FFT_SDF2_12
    PORT MAP( clk => clk,
              ...
              multiply_12_J => multiply_12_J,
              softReset => softReset,
              dout_12_1_re => dout_12_1_re,  -- sfix44_En18
              dout_12_1_im => dout_12_1_im,  -- sfix44_En18
  ...
  u_NaturalOrder_Stage : RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_12_1_vld => dout_12_1_vld,
              softReset => softReset,
              dout_re1 => dout_re1,  -- sfix44_En18
              dout_im1 => dout_im1,  -- sfix44_En18
              dout_vld1 => dout_vld1
              );
  ...
  twdl_1_1_re <= to_signed(1073741824, 32);

  twdl_1_1_im <= to_signed(0, 32);
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_5 <= (OTHERS => to_signed(0, 34));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_5 <= (OTHERS => to_signed(0, 34));
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_8 <= (OTHERS => to_signed(0, 36));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_8 <= (OTHERS => to_signed(0, 36));
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_11 <= (OTHERS => to_signed(0, 38));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_11 <= (OTHERS => to_signed(0, 38));
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_14 <= (OTHERS => to_signed(0, 40));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_14 <= (OTHERS => to_signed(0, 40));
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_16 <= (OTHERS => to_signed(0, 42));
        ELSE 
          intdelay_reg_16(0) <= dout_10_1_re_signed;
  ...
  din_11_1_re_dly <= intdelay_reg_16(2);

  intdelay_17_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_17 <= (OTHERS => to_signed(0, 42));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_17 <= (OTHERS => to_signed(0, 42));
        ELSE 
          intdelay_reg_17(0) <= dout_10_1_im_signed;
  ...
  din_11_1_im_dly <= intdelay_reg_17(2);

  intdelay_18_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_18 <= (OTHERS => '0');
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        IF softReset = '1' THEN
          intdelay_reg_18 <= (OTHERS => '0');
        ELSE 
          intdelay_reg_18(0) <= dout_10_1_vld;
