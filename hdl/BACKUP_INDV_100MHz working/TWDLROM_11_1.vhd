-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/TWDLROM_11_1.vhd
...
-- 
-- Module: TWDLROM_11_1
-- Source Path: sfft_fixpt/dsphdl.FFT/TWDLROM_11_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_10_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#2FF#, 10))) = '1' THEN 
