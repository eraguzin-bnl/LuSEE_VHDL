-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/TWDLROM_5_1.vhd
...
-- 
-- Module: TWDLROM_5_1
-- Source Path: sfft_fixpt/dsphdl.FFT/TWDLROM_5_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_4_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#3FB#, 10))) = '1' THEN 
