...
ARCHITECTURE rtl OF average_instance_P1_fixpt IS
  ...
  SIGNAL tmp_16                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  SIGNAL to2val_2                         : unsigned(31 DOWNTO 0);  -- ufix32_E15
  SIGNAL tmp_17                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  ...
  SIGNAL tmp_21                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  ...
  SIGNAL tmp_32                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  ...
  SIGNAL tmp_35                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  ...
  SIGNAL tmp_36                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  SIGNAL p45to1val_add_cast               : unsigned(34 DOWNTO 0);  -- ufix35_E13
  SIGNAL p45to1val_add_cast_1             : unsigned(34 DOWNTO 0);  -- ufix35_E13
  SIGNAL p45to1val_add_temp               : unsigned(34 DOWNTO 0);  -- ufix35_E13
  SIGNAL to1val_3                         : unsigned(31 DOWNTO 0);  -- ufix32_E15
  SIGNAL tmp_37                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
  SIGNAL tmp_38                           : unsigned(31 DOWNTO 0);  -- ufix32_E15
...
BEGIN
  u_buf2_ram : SimpleDualPortRAM_generic
    ...
    PORT MAP( clk => clk,
              enb => enb_gated_3,
              wr_din => std_logic_vector(tmp_19),
  ...
  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_trueregionp29
  ...
  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_falseregionp64
  ...
  -- HDL code generation from MATLAB function: average__instance_P1__fixpt
  -- 
  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_trueregionp26
  tmp_18 <= to2val_2(30 DOWNTO 0) & '0';

  
  tmp_19 <= val WHEN tmp_1 = '0' ELSE
      tmp_18;
  ...
  tmp_20 <= buf2_1 WHEN tmp_1 = '0' ELSE
      tmp_15;

  p54to2val_add_cast <= resize(tmp_20 & '0', 34);
  p54to2val_add_cast_1 <= resize(P, 34);
  p54to2val_add_temp <= p54to2val_add_cast + p54to2val_add_cast_1;
  to2val_1 <= p54to2val_add_temp(33 DOWNTO 2);
  ...
  tmp_21 <= outpk_2 WHEN tmp_6 = '0' ELSE
      to2val_3;

  tmp_22 <= hdlcoder_to_stdlogic(Nac_1 = to_unsigned(16#1#, 3)) AND ready_in;
  ...
  tmp_24 <= hdlcoder_to_stdlogic(Nac_1 = to_unsigned(16#1#, 3)) AND ready_in;
  ...
  tmp_25 <= p92tmp_add_temp(42 DOWNTO 32);

  
  tmp_26 <= to1adr WHEN ready_in = '0' ELSE
      tmp_25;
  ...
  tmp_27 <= to1adr_2 WHEN tmp_1 = '0' ELSE
      tmp_26;

  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_falseregionp19
  p55tmp_sub_cast <= signed(resize(tmp_27, 32));
  tmp_28 <= p55tmp_sub_cast - 1;

  addr_2 <= to_signed(16#00000401#, 32);

  
  tmp_29 <= tmp_28 WHEN tmp_1 = '0' ELSE
      addr_2;

  indexLogic_fixptsig_2 <= unsigned(tmp_29(10 DOWNTO 0));

  -- 'average__instance_P1__fixpt:31' if ticktock
  addr_3 <= to_signed(16#00000401#, 32);

  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_trueregionp69
  p90tmp_sub_cast <= signed(resize(tmp_26, 32));
  tmp_30 <= p90tmp_sub_cast - 1;

  
  tmp_31 <= addr_3 WHEN tmp_1 = '0' ELSE
      tmp_30;

  indexLogic_fixptsig_3 <= unsigned(tmp_31(10 DOWNTO 0));

  stateControl_11 <= '1';

  tmp_32 <= to_unsigned(0, 32);
  ...
  tmp_33 <= to1val_1 WHEN tmp_24 = '0' ELSE
      to1val;

  
  tmp_34 <= to1val_2 WHEN tmp_1 = '0' ELSE
      tmp_33;

  -- HDL code generation from MATLAB function: average__instance_P1__fixpt_falseregionp16
  ...
  tmp_35 <= to1val_2 WHEN tmp_1 = '0' ELSE
      val_1;
  ...
  tmp_36 <= tmp_32 WHEN tmp_1 = '0' ELSE
      buf1_1;

  p45to1val_add_cast <= resize(tmp_36 & '0' & '0', 35);
  p45to1val_add_cast_1 <= resize(P, 35);
  p45to1val_add_temp <= p45to1val_add_cast + p45to1val_add_cast_1;
  to1val_1 <= p45to1val_add_temp(33 DOWNTO 2);
  ...
  tmp_37 <= outpk_2 WHEN tmp_23 = '0' ELSE
      to1val_3;

  
  tmp_38 <= tmp_21 WHEN tmp_2 = '0' ELSE
      tmp_37;
