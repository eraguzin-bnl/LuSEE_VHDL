-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/RADIX22FFT_SDF1_7.vhd
...
-- Source Path: sfft_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_7
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_7 IS
  ...
  COMPONENT Complex4Multiply_generic
    ...
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          din_im                          :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          vld_in                          :   IN    std_logic;
          twdl_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          softReset                       :   IN    std_logic;
          dinXTwdl_re                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dinXTwdl_im                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
  ...
  COMPONENT SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          xf_im                           :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dinXTwdlf_im                    :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          btf1_im                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          btf2_re                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          btf2_im                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          btf_vld                         :   IN    std_logic;
          softReset                       :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
          wrData_im                       :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En18
  ...
  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(37 DOWNTO 0);  -- sfix38_En18
  SIGNAL din_re                           : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL din_7_1_im_dly_signed            : signed(37 DOWNTO 0);  -- sfix38_En18
  SIGNAL din_im                           : signed(38 DOWNTO 0);  -- sfix39_En18
  ...
  SIGNAL dinXTwdl_re_signed               : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL dinXTwdl_im_signed               : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL btf2_re                          : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL btf1_im                          : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL btf1_re                          : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL dinXTwdlf_im                     : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL dinXTwdlf_re                     : signed(38 DOWNTO 0);  -- sfix39_En18
  SIGNAL xf_im                            : signed(38 DOWNTO 0);  -- sfix39_En18
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_add_cast      : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(39 DOWNTO 0);  -- sfix40_En18
  SIGNAL xf_re                            : signed(38 DOWNTO 0);  -- sfix39_En18
  ...
  signal din_7_vld_dly_r                   : std_logic_vector(15 DOWNTO 0);
...
BEGIN
  u_MUL4 : Complex4Multiply_generic
    ...
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix39_En18
              din_im => std_logic_vector(din_im),  -- sfix39_En18
              vld_in => din_7_vld_dly,
              twdl_re => twdl_7_1_re,  -- sfix32_En30
              twdl_im => twdl_7_1_im,  -- sfix32_En30
              softReset => softReset,
              dinXTwdl_re => dinXTwdl_re,  -- sfix39_En18
              dinXTwdl_im => dinXTwdl_im,  -- sfix39_En18
              vld_out => dinXTwdl_7_1_vld_1 
              );
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix39_En18
              xf_im => std_logic_vector(xf_im),  -- sfix39_En18
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix39_En18
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix39_En18
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix39_En18
              btf1_im => std_logic_vector(btf1_im),  -- sfix39_En18
              btf2_re => std_logic_vector(btf2_re),  -- sfix39_En18
              btf2_im => std_logic_vector(btf2_im),  -- sfix39_En18
              btf_vld => btf_vld,
              softReset => softReset,
              wrData_re => wrData_re,  -- sfix39_En18
              wrData_im => wrData_im,  -- sfix39_En18
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix39_En18
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix39_En18
