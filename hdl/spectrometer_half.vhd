...
ENTITY spectrometer_half IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        clk_enable                        :   IN    std_logic;
        Navg_notch                        :   IN    std_logic_vector(9 DOWNTO 0);  -- sfix14
        Navg_main                         :   IN    std_logic_vector(9 DOWNTO 0);  -- sfix14
        ch1_val_re_in                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix14
        ch1_val_im_in                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix14
...
END spectrometer_half;


ARCHITECTURE rtl OF spectrometer_half IS
 ...
 SIGNAL error_notch			     :   std_logic_vector(15 DOWNTO 0);
 SIGNAL error_main 			     :   std_logic_vector(15 DOWNTO 0);
...
BEGIN
    notch_ready <= notch_en and fft_ready_in;

    process (clk) begin
        if (rising_edge(clk)) then

            ch1_val_re_s1           <= ch1_val_re_in;
            ch1_val_im_s1           <= ch1_val_im_in;
            ch2_val_re_s1           <= ch1_val_re_in;
            ch2_val_im_s1           <= ch1_val_im_in;
            bin_s1                  <= bin_in;
