-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/sfft/hdlsrc/RADIX22FFT_CTRL1_9.vhd
...
-- Source Path: sfft_fixpt/dsphdl.FFT/RADIX22FFT_CTRL1_9
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_9_Enb <= '0';
        IF (dinXTwdl_9_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
