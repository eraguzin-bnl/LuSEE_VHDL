...
BEGIN
  ...
  tmp_re <= varargout_1_re_signed(42 DOWNTO 11);
  tmp_im <= varargout_1_im_signed(42 DOWNTO 11);

  fft_out_re <= std_logic_vector(tmp_re);

  fft_out_im <= std_logic_vector(tmp_im);
