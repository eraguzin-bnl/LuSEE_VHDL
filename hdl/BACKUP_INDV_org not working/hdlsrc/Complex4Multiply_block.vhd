-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/spectrometer/hdlsrc/Complex4Multiply_block.vhd
...
-- Source Path: spectrometer_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_5/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(36 DOWNTO 0);  -- sfix37_En18
  SIGNAL din_re_reg                       : signed(36 DOWNTO 0);  -- sfix37_En18
  SIGNAL din_im_signed                    : signed(36 DOWNTO 0);  -- sfix37_En18
  SIGNAL din_im_reg                       : signed(36 DOWNTO 0);  -- sfix37_En18
  ...
  SIGNAL Complex4Multiply_din1_re_pipe1   : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL Complex4Multiply_din1_im_pipe1   : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL Complex4Multiply_mult1_re_pipe1  : signed(68 DOWNTO 0);  -- sfix69
  SIGNAL Complex4Multiply_mult2_re_pipe1  : signed(68 DOWNTO 0);  -- sfix69
  SIGNAL Complex4Multiply_mult1_im_pipe1  : signed(68 DOWNTO 0);  -- sfix69
  SIGNAL Complex4Multiply_mult2_im_pipe1  : signed(68 DOWNTO 0);  -- sfix69
  ...
  SIGNAL prod1_re                         : signed(68 DOWNTO 0);  -- sfix69_En48
  SIGNAL prod1_im                         : signed(68 DOWNTO 0);  -- sfix69_En48
  SIGNAL prod2_re                         : signed(68 DOWNTO 0);  -- sfix69_En48
  SIGNAL prod2_im                         : signed(68 DOWNTO 0);  -- sfix69_En48
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL Complex4Add_sub_cast             : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL Complex4Add_sub_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL Complex4Add_add_cast             : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL Complex4Add_add_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL mulResFP_re                      : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL mulResFP_im                      : signed(69 DOWNTO 0);  -- sfix70_En48
  SIGNAL dinXTwdl_re_tmp                  : signed(36 DOWNTO 0);  -- sfix37_En18
  SIGNAL dinXTwdl_im_tmp                  : signed(36 DOWNTO 0);  -- sfix37_En18
