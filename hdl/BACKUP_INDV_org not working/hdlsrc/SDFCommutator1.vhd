-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/spectrometer/hdlsrc/SDFCommutator1.vhd
...
-- Source Path: spectrometer_fixpt/dsphdl.FFT/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL xf_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL dinXTwdlf_re_signed              : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL dinXTwdlf_im_signed              : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL btf1_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL btf1_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL btf2_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL btf2_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFCummutator_out_im_next        : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  SIGNAL wrData_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL wrData_im_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL wrAddr_tmp                       : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL xData_re                         : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL xData_im                         : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  SIGNAL dout0_re                         : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL dout0_im                         : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL xX_im                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_1_re_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En18
  SIGNAL dout_1_1_im_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En18
  ...
  BEGIN
    ...
    CASE SDFCummutator_XState IS
      WHEN "000" =>
        ...
        IF ((SDFCummutator_wrEnb_xmem AND hdlcoder_to_stdlogic(SDFCummutator_wrAddr_reg = to_unsigned(16#7F7#, 11))) AND SDFCummutator_wrEnb_reg) = '1' THEN 
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#7FF#, 11)) AND btf_vld) = '1' THEN 
      ...
      WHEN "10" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#2#, 2);
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#7F7#, 11)) AND xf_vld) = '1' THEN 
          SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
