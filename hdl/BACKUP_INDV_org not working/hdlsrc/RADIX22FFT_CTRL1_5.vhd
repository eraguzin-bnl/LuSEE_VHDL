-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/spectrometer/hdlsrc/RADIX22FFT_CTRL1_5.vhd
...
-- Source Path: spectrometer_fixpt/dsphdl.FFT/RADIX22FFT_CTRL1_5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_5_Enb <= '0';
        IF (dinXTwdl_5_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7F#, 7))) = '1' THEN 
