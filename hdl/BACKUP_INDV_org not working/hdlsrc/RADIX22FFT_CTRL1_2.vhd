-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/spectrometer/hdlsrc/RADIX22FFT_CTRL1_2.vhd
...
-- Source Path: spectrometer_fixpt/dsphdl.FFT/RADIX22FFT_CTRL1_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF (dout_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3FF#, 10))) = '1' THEN 
