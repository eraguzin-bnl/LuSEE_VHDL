-- -------------------------------------------------------------
-- 
-- File Name: /u/home/eraguzin/matlab/LNspec/matlab/codegen/spectrometer/hdlsrc/spectrometer_fixpt_tb_pkg.vhd
...
PACKAGE spectrometer_fixpt_tb_pkg IS
  -- Functions
  ...
  FUNCTION to_hex(x : IN vector_of_signed32) RETURN string;
END spectrometer_fixpt_tb_pkg;


PACKAGE BODY spectrometer_fixpt_tb_pkg IS
  ...
  FUNCTION to_hex(x : IN vector_of_signed32) RETURN string IS
    VARIABLE result : STRING(1 TO 36);
    VARIABLE i      : INTEGER;
    VARIABLE j      : INTEGER;
    VARIABLE k      : INTEGER;
    VARIABLE m      : INTEGER;
